...
3. When the run finishes, download the artifact **VisualFolderExplorer_v1.0.3_win-x64-portable**.
4. Inside it is `VisualFolderExplorer_v1.0.3_win-x64-portable.zip`.
